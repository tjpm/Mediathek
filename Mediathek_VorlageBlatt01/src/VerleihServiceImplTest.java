...
public class VerleihServiceImplTest
{
    ...
    @Test
    public void testUebernammeVerleihstatus()
    {
    ...
    @Test
    public void testKundenzuordnungVerliehenemedien()
    {
    	List<Medium> medien = new ArrayList<Medium>();
    	medien.add(_shape);
		medien.add(_bad);
		...
		List<Medium> gelieheneMedien = _verleihService.getAusgelieheneMedienFuer(_roger);
    ...
    @Test
    public void testNimmAusgelieheneMedienZurueck()
    {
    	List<Medium> medien = new ArrayList<Medium>();
		medien.add(_abbey);
		medien.add(_shape);
